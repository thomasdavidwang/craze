...
export default function UserCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setHasSignedUp(initialValues.hasSignedUp);
    setErrors({});
  };
  const validations = {
    firstName: [],
      ...
      <SwitchField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.hasSignedUp ?? value;
          }
          if (errors.hasSignedUp?.hasError) {
            runValidationTasks("hasSignedUp", value);
          }
          setHasSignedUp(value);
        }}
        onBlur={() => runValidationTasks("hasSignedUp", hasSignedUp)}
        errorMessage={errors.hasSignedUp?.errorMessage}
        hasError={errors.hasSignedUp?.hasError}
        {...getOverrideProps(overrides, "hasSignedUp")}
      ></SwitchField>
      <Flex
